...
To begin data preparation, access the `Robot PC` either directly or via SSH. See the [Software Setup](/ai_worker/setup_guide_software_ai_worker#accessing-the-robot-pc-via-ssh) guide for instructions on how to connect via SSH.
