...
The **Preset** feature allows you to save and load up to **three custom configurations**. This is ideal for quickly switching between predefined poses or grip patterns.
