...
| **Policy Path**      | The **absolute** path to your trained model checkpoint. This should point to the directory containing your trained model files (e.g., `/root/trained_model/ffw_act/pretrained/`).                                                                                                                                                                                                                                                                                                |
:::
