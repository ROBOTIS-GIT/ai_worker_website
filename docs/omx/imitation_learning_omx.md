...
This document provides an overview of the complete ROS 2-based imitation learning pipeline built on the OMX and the Hugging Face Hub and features a user-friendly web GUI designed to streamline interaction and enhance accessibility.
...
Once trained, the models are deployed on the OMX to execute real-time inference for tasks such as picking, placing, and obstacle avoidance.
...
- The same workflow is also applicable to **OMX** using the **Web GUI**.
