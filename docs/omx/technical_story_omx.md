...
python3 src/open_manipulator/open_manipulator_playground/src/omx_drawing_shape.py   --ros-args -p traj_topic:=/arm_controller/joint_trajectory -p interactive:=true -p use_sim_time:=true
