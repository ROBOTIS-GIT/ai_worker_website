...
This guide shows how to run the Cyclo Motion Controller from [`cyclo_control`](https://github.com/ROBOTIS-GIT/cyclo_control) on OMY.
...
![movej_control](/simulation/omy/omy_movej.gif)
